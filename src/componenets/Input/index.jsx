export const Input = ({ name, label, error, ...props }) => (
    <div className="flex flex-col">
        ...
        <input {...props} name={name} id={name} className={`p-3 border border-gray-700 rounded-xl focus:outline focus:outline-1 focus:outline-gray-700 ${error && 'border-red-300 border-2'}`} />
